...
SEQ_POTION			=3		--Top rightmost Supply Zone
...
EFFECT_UPDATE_VP					=601	--(reserved) Increase/decrease the VP a card is worth
EFFECT_CHANGE_COIN					=602	--Set the $ a card is worth ("Philosopher's Stone" 4-010)
EFFECT_UPDATE_COIN					=603	--(reserved) Increase/decrease the $ a card is worth
EFFECT_CHANGE_POTION				=604	--(reserved) Set the P a card is worth
EFFECT_UPDATE_POTION				=605	--(reserved) Increase/decrease the P a card is worth
EFFECT_PLAY_ACTION_TWICE			=610	--Action card may be played twice ("Throne Room" 1-024)
EFFECT_UPDATE_COPPER_PRODUCE		=611	--Increase/decrease the amount of coin Copper produces ("Coppersmith" 2-013)
EFFECT_UPDATE_SILVER_PRODUCE		=612	--(reserved) Increase/decrease the amount of coin Silver produces
EFFECT_UPDATE_GOLD_PRODUCE			=613	--(reserved) Increase/decrease the amount of coin Gold produces
EFFECT_UPDATE_PLATINUM_PRODUCE		=614	--(reserved) Increase/decrease the amount of coin Platinum produces
...
OPTION_GUILDS			=1659	--(reserved) Guilds
OPTION_ADVENTURES		=1660	--(reserved) Adventures
OPTION_EMPIRES			=1661	--(reserved) Empires
OPTION_NOCTURNE			=1662	--(reserved) Nocturne
OPTION_RENAISSANCE		=1663	--(reserved) Renaissance
