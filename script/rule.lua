...
function Rule.EndGameOperation(e,tp,eg,ep,ev,re,r,rp)
	...
	local g3=Duel.GetMatchingGroup(Card.IsType,PLAYER_ONE,LOCATION_DECK,0,nil,TYPE_VICTORY)
	local g4=Duel.GetMatchingGroup(Card.IsType,PLAYER_TWO,LOCATION_DECK,0,nil,TYPE_VICTORY)
